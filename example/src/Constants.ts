...
export abstract class Constants {
  ...
  static readonly OliviaHafezPhoneJwt =
  ...
  static readonly OliviaHafezEmailJwt =
  ...
  static readonly PresentationSelectionsList = [
    {
      ...
      jwtVc: Constants.OliviaHafezPhoneJwt,
    },
    {
      inputDescriptor: 'EmailV1.0',
      jwtVc: Constants.OliviaHafezEmailJwt,
    },
  ];
  ...
  static readonly SomeJjwkPublic: VCLJwkPublic = {
    valueStr:
